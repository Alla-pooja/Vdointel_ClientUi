...
//   ]; 
  ...
  const TABLE_HEAD = [
    { id: 'rownumber', label: 'S No', alignRight: false },
    ...
    { id: 'LocalDeviceName', label: 'Local camera name', alignRight: false },
    { id: 'Category', label: 'Category', alignRight: false },
    { id: 'TimeZone', label: 'Time Zone', alignRight: false },
    { id: 'Archives', label: 'Archives', alignRight: false },
    { id: 'CameraView', label: 'Camera Type', alignRight: false },
    { id: 'Speaker', label: 'Speaker', alignRight: false },
    { id: '',label:'',alignRight:true},
  ];
  ...
  function getComparator(order, orderBy) {
    console.log("Update OR=====", order, orderBy)
    return order === 'desc'
  ...
  function applySortFilter(array, comparator, query) {
    ...
    if (query) {
      return filter(array, (_user) => {
        return ['deviceid', 'devicename', 'displayname','rownumber','LocalDeviceName','Category','CameraView','Speaker'].some((property) => {
    ...
    return (
      <>
        <Box>
            ...
            <DeviceDrawDialog/>
            <Scrollbar>
                <TableContainer sx={{ minWidth: 800,maxHeight:900 }}>
